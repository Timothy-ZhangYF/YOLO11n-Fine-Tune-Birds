...
<p align="center">
  <strong>DSLR AI Tracking AF vs Raspberry Pi Model Deployment Demo</strong>
  <br><br>
  <img src="Images/CameraAF.gif" alt="Demo" width="35%" />
  <img src="Images/raspi_demo.gif" alt="Pi Demo" width="46%" />
</p>
...
* **Operational Flexibility:** In real-time applications, dropping the deployment cutoff to `conf = 0.4` unlocks **`0.891` recall at `0.942` precision**, which matches/exceeds Medium's coverage while maintaining a massive speed advantage.

```
Conf    Precision   Recall      F1          mAP@50      mAP@50-95
-----------------------------------------------------------------
0.30    0.918       0.902       0.910       0.951       0.760       
0.33    0.926       0.900       0.913       0.951       0.760       
0.35    0.931       0.896       0.913       0.951       0.760       
0.38    0.938       0.892       0.915       0.951       0.760       
0.40    0.942       0.891       0.916       0.951       0.760       
0.42    0.945       0.886       0.915       0.951       0.760       
0.45    0.951       0.882       0.915       0.951       0.760       
0.47    0.956       0.877       0.915       0.951       0.760       
0.50    0.961       0.874       0.916       0.951       0.760       
0.53    0.964       0.870       0.915       0.951       0.760       
0.55    0.970       0.866       0.915       0.951       0.760       
-----------------------------------------------------------------
Max F1 at Conf = 0.54: Precision = 0.968 | Recall = 0.870 | F1 = 0.916
```
